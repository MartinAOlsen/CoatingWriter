...
cd D:\Dropbox\Dropbox\Dropbox\CoatingWriter_2.3.01b
...
%% 2 Mode specific options
    ...
    elseif strcmp(Mode,'budget')
        ...
        CW_input.Price=[1000 250 3000];                        % Target price
        CW_input.budgetMaxError=10;                 % Maximum unpunished error in price
...
%% 3 Segment parameters
    ...
    CW_input.Input1.deltaM=0.5           % The lowest amount the m-value can change each step
    ...
    % Segment 2 
    CW_input.Input2.type='G'
    CW_input.Input2.mode='specific'
    CW_input.Input2.distribution='none'

    % Segment 3
    CW_input.Input3.type='P'
    CW_input.Input3.mode='specific'
    CW_input.Input3.distribution='power'
    CW_input.Input3.mincenter=0
    CW_input.Input3.maxcenter=1
    CW_input.Input3.fixSides='HV';
    CW_input.Input3.deltaM=0.5
    CW_input.Input3.mStepLength=0.5
    CW_input.Input3.remove_m_under=1;
    CW_input.Input3.remove_m_over=6;
    CW_input.Input3.substrate='RH'



%Hvis linjen herunder udkommenteres, printes CW ikke automatisk til
%instrumentfiler.
% CW_input.filePath='/media/martin/HDD1/Dropbox/Dropbox/Dropbox/guideBot_newest/test1/PGE'
CW_input.filePath='D:\Dropbox\Dropbox\Dropbox\guideBot_newest\test1\PGE'
